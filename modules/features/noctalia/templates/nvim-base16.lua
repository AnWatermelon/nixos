-- matugen template: renders to ~/.local/state/nvim/matugen/base16.lua.
-- Must return a plain table, not call setup(): lua/matugen.lua dofile()s the
-- rendered file and merges it over its fallback palette.
return {
